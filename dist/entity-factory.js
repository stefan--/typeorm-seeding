            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this.resolveEntity;
                        return [4 /*yield*/, this.factory(Faker, this.context)];
                    case 1: return [4 /*yield*/, _a.apply(this, [_b.sent(), isSeeding])];
                    case 2:
                        entity = _b.sent();
                        if (!this.mapFunction) return [3 /*break*/, 4];
